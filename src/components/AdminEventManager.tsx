  ...
  const handleEditEvent = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/events", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ id: editingEventId, ...editForm }),
      });
    ...
    <div className="space-y-4">
      ...
      {showCreateForm && (
        <div className="bg-white rounded-2xl shadow-sm p-5">
          <h3 className="text-green-900 font-semibold mb-4">New School Event Details</h3>
      ...
      {/* Events List */}
      <div className="bg-white rounded-2xl shadow-sm p-5">
        <h2 className="text-green-900 font-semibold text-lg mb-4">School Events</h2>
        {events.length === 0 ? (
              ...
              >
                {editingEventId === event.id ? (
                  ...
                  <form onSubmit={handleEditEvent} className="space-y-3">
                    <h4 className="text-green-900 font-semibold text-sm mb-2">Edit Event</h4>
                    <div>
                  ...
                  <>
                    ...
                    {deleteConfirm === event.id && (
                      <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-xl">
                        <p className="text-red-700 text-sm mb-2">
                          Are you sure you want to delete this event? This will also remove all attendance records.
                        </p>
                        <div className="flex gap-2">
                          <button
                    ...
                    <button
                      ...
                      className="w-full bg-green-600 hover:bg-green-700 text-white text-sm font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2 transition-colors mt-3"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
